    ...
    , ui(new Ui::SettingsDialog)
{
    ...
    ui->input_difficulty->setCurrentText(DifficultyUtil::difficultyToString(Settings::instance().getDifficulty()));
}
...
void SettingsDialog::on_buttonBox_accepted()
{
    ...
    else                                                 validInput = Settings::instance().setSettings(DifficultyUtil::stringToDifficulty(ui->input_difficulty->currentText()));
...
void SettingsDialog::on_input_difficulty_currentTextChanged(const QString &text)
{
    ...
    const Difficulty& currentSelection = DifficultyUtil::stringToDifficulty(text);
